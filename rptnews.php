	...
	<div id="header">
	  <div class="clearfix">
            ...
            <div id="div">
              ...
              <p align='right'> <font color='#FFFFFF'>Welcome <?php echo $_SESSION["fullnm"]; ?>
			  </font> <img src="<?php echo $fnm; ?>" width="100" height="100" align="right"> </p>
            </div>
	  </div>
	</div>
	<div id="contents">
...
include_once("dbconfig.php");
	...
	echo "<h1 align='center'>News List</h1>";
...
?>
	...
	<div id="footer">
	  <div class="clearfix"></div>
		<div id="footnote">
			<div class="clearfix">
			  <div align="center"><a href="reportlist.php" class="subscribe  style8">Click To Back</a>
		      </div>
			  <div class="connect">
